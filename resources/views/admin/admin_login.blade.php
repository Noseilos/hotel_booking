									...
									<div class="form-body">
                                        <form method="POST" class="row g-3" action="{{ route('login') }}">
											...
											<div class="col-12">
												...
												<input type="text" name="login" class="form-control @error('login') is-invalid @enderror" id="inputEmailAddress" placeholder="jhon@example.com">
												@error('login')
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" name="password" id="password" class="form-control border-end-0" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
												</div>
											</div>
											<div class="col-md-6">
